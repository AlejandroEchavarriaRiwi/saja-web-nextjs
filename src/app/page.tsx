...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-blue-50 to-green-50 dark:from-gray-900 dark:to-gray-800">
      <header className="px-4 lg:px-36 h-16 flex items-center bg-white dark:bg-gray-800 shadow-md">
      ...
      <main className="flex-1">
        <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-gradient-to-r from-primary via-blue-500 to-secondary text-white flex justify-center">
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-xl md:text-2xl text-blue-100">
                  Desarrollo web, ecommerce y aplicaciones a medida para
              ...
              <div className="space-x-4">
                ...
                <Button
                  ...
                  variant="outline"
                  size="lg"
                  className="text-gray-800 border-white hover:bg-white/10"
                >
        ...
        >
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-center mb-8 bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary">
              Nuestros Servicios
            </h2>
            <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
              <div className="flex flex-col items-center space-y-2 p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg transition-transform hover:scale-105">
                <Code className="h-12 w-12 text-primary dark:text-blue-400 mb-2" />
                <h3 className="text-xl font-bold">Desarrollo Web</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
                  Creamos sitios web personalizados y optimizados para tu
                  negocio.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg transition-transform hover:scale-105">
                <ShoppingCart className="h-12 w-12 text-secondary dark:text-green-400 mb-2" />
              ...
              <div className="flex flex-col items-center space-y-2 p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg transition-transform hover:scale-105">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
                  Creamos aplicaciones web a medida para optimizar tus procesos
                  de negocio.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg transition-transform hover:scale-105">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
                  Optimizamos tu presencia online para aumentar tu visibilidad
                  en buscadores.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg transition-transform hover:scale-105">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
                  Aseguramos que tu sitio se vea genial en todos los
                  dispositivos.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg transition-transform hover:scale-105">
        ...
        <section
          id="planes"
          className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-br from-primary-100 to-secondary-100 dark:from-gray-800 dark:to-gray-700 flex justify-center"
        >
          <div className="container px-4 md:px-6 ">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-center mb-8 bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary">
              Nuestros Planes
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              <div className="flex flex-col p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg transition-transform hover:scale-105">
                <h3 className="text-2xl font-bold text-center mb-4 text-primary dark:text-blue-400">
                  Básico
                </h3>
                ...
                <Button className="mt-auto bg-primary hover:bg-blue-700 text-white">
                  Elegir Plan
                </Button>
              </div>
              <div className="flex flex-col p-6 bg-gradient-to-br from-primary to-secondary text-white rounded-xl shadow-lg transition-transform hover:scale-105">
                ...
                <Button className="mt-auto bg-white text-primary hover:bg-blue-50">
                  Elegir Plan
                </Button>
              </div>
              <div className="flex flex-col p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg transition-transform hover:scale-105">
                <h3 className="text-2xl font-bold text-center mb-4 text-secondary dark:text-green-400">
                  Empresarial
                </h3>
                <ul className="mb-6 space-y-2">
                  <li className="flex items-center">
                ...
                <Button className="mt-auto bg-secondary hover:bg-green-600 text-white">
                  Elegir Plan
                </Button>
              </div>
            </div>
